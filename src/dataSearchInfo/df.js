    ...
    'https://dec.fazenda.df.gov.br':[
        {
            ...
            '__verifyFunc':
                async ($) => {
                    return $.html().includes('ui-collapsible-heading-toggle')
                },
            ...
            'datetime':{
                selector: "#infos > div:nth-child(4) > div > ul",
                re: /Emissão: (.+)\n/
            },    
        },

        {
            // idDocumento ex.: 53200137130481000160650010002429071397394501,
            ...
            'customer_name':{
                selector: "#infos > div:nth-child(1) > ul",
                re: /Nome:([A-Za-z,\s]+)/,
                func: x=> x.replace(/^\s+|\s+$|\s+(?=\s)/g, '')
            ...
            'datetime':{
                selector: "#infos > div:nth-child(4) > ul > li",
                re: /Emissão: (.+)\n/
            },    
        },
